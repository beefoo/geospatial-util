...
# 250 mb = 250 millibars = 250,000 bars ~= 10,500 meters above ground (troposphere)
...
parser.add_argument('-out', dest="OUTPUT_DIR", default="data/troposphere_wind", help="Output dir")
